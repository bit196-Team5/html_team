...
$('#addbutt').on('click',function(){
    let div = $('<div>새로운 내용을 입력하세요</div>');
    div.addClass('text').attr('contenteditable','true');
    let h3 = $('<h3>task</h3>');
    h3.addClass('title dd-handle');
    let li = $('<li></li>');
    li.addClass('dd-item').attr('data-id','1');
    li.append(h3);
    li.append(div);
    $('#To-do').after(li);
});
